...
urlpatterns = [
    ...
    path('api/ships/<int:ship_id>/add_to_icebreaker/',
         add_ship_to_icebreaker),  # POST
    ...
    path('api/icebreakers/<int:icebreaker_id>/update_status_user/',
         update_status_user),  # PUT
    path('api/icebreakers/<int:icebreaker_id>/update_status_admin/',
         update_status_admin),  # PUT
    path('api/icebreakers/<int:icebreaker_id>/delete/',
         delete_icebreaker),  # DELETE

    # Набор методов для м-м
    path('api/icebreakers/<int:icebreaker_id>/update_ship/<int:ship_id>/',
         update_ship_in_icebreaker),  # PUT
    path('api/icebreakers/<int:icebreaker_id>/delete_ship/<int:ship_id>/',
         delete_ship_from_icebreaker),  # DELETE
